...
class NullKeyring implements IKeyring {
  ...
  generateAndStoreMnemonic(_password?: string): Promise<string> {
    throw new Error("generateAndStoreMnemonic");
  }

  getAddressesForStoredPrivateKeys(): Promise<string[]> {
    throw new Error("getAddressesForStoredPrivateKeys");
  }
  ...
  generateAddressForMnemonic(
    ...
    throw new Error("generateAddressForMnemonic");
  }
  ...
  generateAndStorePrivateKey(
    ...
    throw new Error("generateAndStorePrivateKey");
  }

  removePrivateKey(_address: string): Promise<boolean> {
    throw new Error("removePrivateKey");
  }
  ...
  signTransactionHashForAddress(
    ...
    throw new Error("signTransactionHashForAddress");
  }

  signMessageForAddress(_address: string, _message: string): Promise<string> {
    throw new Error("signMessageForAddress");
  }
  ...
  signHashForAddress(
    ...
    throw new Error("signHashForAddress");
  }
}
