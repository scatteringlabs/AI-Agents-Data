...
export const TableDrawerRowERC20Z = ({
  item,
  collectionAddress,
  title,
  closeDialog,
  ...
  return (
    ...
    >
      ...
      >
        ...
        <TableCell
          className={`${Number(item.price_change_in_24hours) < 0 ? "danger" : "success"}`}
        >
          <PriceChangeText priceChange={item.price_change_in_24hours} />
        </TableCell>
        <TableCell>
          <Typography
            sx={{
