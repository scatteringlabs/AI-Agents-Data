...
export const SCAN_URL_NAME: { [key: string]: string } = {
  ETH_MAINNET: "https://etherscan.io/",
  ARB_MAINNET: "https://arbiscan.io/",
  BASE_MAINNET: "https://basescan.org/",
};

export const XApiKey = "6f80cede-fe7c-43b5-8eb3-3ac59dd8602c";
export const ZoraXApiKey = "epz4afebvjemayeod29khazncqav2dodwkj";
