...
import SwapDialog from "../MPL404/SwapTokenDialog";
import SwapNFTDialog from "../MPL404/SwapNFTDialog";
    ...
    <Box sx={{ mt: 4 }}>
      <Grid container spacing={2}>
        <SwapCard
          ...
          conversionText={`Convert: ${Number(deploymentData?.limitPerMint)} ${symbol} => 1 NFT`}
        ...
        <SwapCard
          ...
          conversionText={`Convert: 1 NFT => ${Number(deploymentData?.limitPerMint)} ${symbol}`}
