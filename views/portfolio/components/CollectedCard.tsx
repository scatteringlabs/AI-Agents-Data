...
import { CollectedNode } from "@/services/graphql/zora/collected-list";
...
const CollectedCard: React.FC<CollectedCardProps> = ({ item, activeTab }) => {
  const imageUrl =
  ...
  return item?.salesStrategy?.sale?.endTime !== "ACTIVE" ? (
    <Content />
  ) : (
    <Link
