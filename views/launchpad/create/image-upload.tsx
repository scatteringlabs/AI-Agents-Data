...
const SingleImageUpload2: React.FC<SingleImageUploadProps> = ({
  onImageUpload,
  tips = "Size 500x500 JPG, PNG, GIF, SVG, 3MB",
  tips2 = "",
  aspectRatio = "1/1",
}) => {
  ...
  const { getRootProps, getInputProps } = useDropzone({
    ...
    onDrop: (acceptedFiles) => {
      if (acceptedFiles.length > 0) {
        ...
        onImageUpload(selectedFile); // 将文件传递给父组件
      }
    },
  });
...
export default SingleImageUpload2;
