...
import { initializeUmi } from "@/utils/umi";
...
import AssetCard from "@/views/trade/swap/sol/wallet/AssetCard";
import MyNFTCard from "@/views/trade/evm/wallet/ReservoirNFTCard";
...
const WalletPage = ({
  ...
  const { isConnected, address: a } = useAccount();
  ...
  return (
    <Box>
      <AssetCard
        ...
        cardLoading={false}
        setActiveTab={() => {
          router.push(`/collection/${slug}`, undefined, {
            shallow: true,
          });
          setActiveTab("trade");
        }}
      ...
      {!nfts?.totalCount && !isLoading && isConnected ? (
