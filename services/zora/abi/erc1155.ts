export const ERC155ABI = [
  {
    inputs: [
      ...
      { internalType: "address", name: "_timedSaleStrategy", type: "address" },
    ],
  ...
  { inputs: [], name: "OnlyAllowedForRegisteredMinter", type: "error" },
  { inputs: [], name: "OnlyAllowedForTimedSaleStrategy", type: "error" },
